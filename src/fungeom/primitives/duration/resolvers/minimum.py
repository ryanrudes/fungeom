"""The shorter (more negative) of two durations."""
...
class MinDuration(Duration):
    """``min(a, b)`` — resolvable iff both are.

    Durations are signed seconds and so totally ordered; the minimum is the more
    negative (earlier-leaning) span.
    """
